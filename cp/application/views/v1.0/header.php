 		...
 		<div class="menu">
      	<ul>
            ...
            <?php if ($this->gets[0] == 'projektek'): ?>
              <li class="sub <?=($this->gets[0] == 'projektek' && $this->gets[1] == 'aktualis')?'on':''?>"><a href="/projektek/aktualis" title="<?=__('Aktív projektek')?>"><span class="ni">8</span><i class="far fa-folder-open"></i> <?=__('Aktív projektek')?> <? if($this->badges['projects']['inprogress']!=0): ?><span class="badge badge-danger"><?=$this->badges['projects']['inprogress']?></span><? endif; ?></a></li>
