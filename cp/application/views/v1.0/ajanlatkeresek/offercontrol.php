  ...
  <div class="data-container">
    <div class="d-flex">
      <div class="request-list">
        ...
        <div class="req-list">
          <div class="request-service"  ng-repeat="request in requests">
            <div class="wrapper">
              <div class="head">
              ...
              <div class="request-subservice" ng-repeat="r in request.items">
                ...
                <div class="request" ng-class="{'active': (readrequest == u.ID), 'closed': (u.request_closed==1), 'declined': (u.recepient_declined==1), 'accepted': (u.recepient_accepted==1)}" ng-repeat="u in r.users" ng-click="pickRequest(u)">
                  <div class="head">
                    <span class="name">{{u.requester_form_name}}</span> <span ng-if="u.requester_form_company && u.requester_form_company!=''" class="company">// <strong>{{u.requester_form_company}}</strong></span>
                    <div class="badges">
              ...
              <div class="row">
                ...
                <div class="col-md-6 text-right">
                  <div class="" ng-if="request.request_closed==0">
                    <button type="button" class="btn btn-sm btn-success" ng-click="prepareOfferSend(request.ID)"><?=__('ÉRDEKEL - Ajánlatot küldök')?> <i class="fas fa-check"></i></button>
                    <button type="button" class="btn btn-sm btn-danger" ng-click="runRequestAction(request.ID, 'decline')"><?=__('NEM ÉRDEKEL - Tárgytalan')?> <i class="fas fa-times"></i></button>
                  </div>
