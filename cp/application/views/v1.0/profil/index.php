...
<form action="" method="post" enctype="multipart/form-data">
	<div class="row">
      ...
      <? if($data[user_group] == \PortalManager\Users::USERGROUP_USER || $data[user_group] == \PortalManager\Users::USERGROUP_SERVICES): ?>
			...
			<div class="row">
				<div class="col right">
					<button class="btn btn-success" name="saveProfil">Változások mentése <i class="fa fa-save"></i></button>
				</div>
			</div>
		</div>
		<div class="col">
      <div class="wblock color-red">
				<div class="data-header">
					<div class="d-flex align-items-center">
						<div class="col title">
							<i class="fas fa-lock"></i> <?=__('Jelszó módosítása')?>
						</div>
						<div class="col right"></div>
					</div>
				</div>
				<div class="data-container">
					<div class="dc-padding">
						<div class="row">
							<div class="col-sm-12">
								<label for="passchange_old"><?=__('Régi jelszava')?> *</label>
								<input type="password" id="passchange_old" class="form-control" name="passchange[old]" value="">
							</div>
						</div>
            <div class="row">
							<div class="col-sm-12">
								<label for="passchange_new"><?=__('Új jelszó')?> *</label>
								<input type="password" id="passchange_new" class="form-control" name="passchange[new]" value="">
							</div>
						</div>
            <div class="row">
							<div class="col-sm-12">
								<label for="passchange_new2"><?=__('Új jelszó újra')?> *</label>
								<input type="password" id="passchange_new2" class="form-control" name="passchange[new2]" value="">
							</div>
						</div>
					</div>
				</div>
        <div class="data-footer text-right">
          <button class="btn btn-danger" name="changePassword"><?=__('Jelszó csere')?> <i class="fas fa-sync"></i></button>
        </div>
			</div>
		</div>
	</div>
